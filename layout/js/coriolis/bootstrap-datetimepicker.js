/* 
 * Modification du plugin bootstrap-datetimepicker.js
 * Ajout de l'heure de début et de fin dans la sélection des heures
 */
...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		fill: function () {
			...
			for (var i = this.hourMin; i < this.hourMax; i++) {
			...
			txt = '', meridian = '', meridianOld = '';
                        html.push('<legend style="font-size: 12px; margin: 0">Veuillez affiner votre heure de rappel</legend>');
